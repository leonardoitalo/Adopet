...
class ModelTutorTestCase(TestCase):
    def setUp(self):
        ...
        self.adoption = Adoption.objects.create(
            date=datetime.date.today(), pet=self.pet_adopted, tutor=self.tutor
        )
    ...
    def test_check_pet_attributes(self):
        ...
        self.assertEqual(
            self.pet.image,
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQktXg5_v8-L9AslphhrFvphE12SWkGl-_Jig&usqp=CAU",
        )
