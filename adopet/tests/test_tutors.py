...
class TutorsTestCase(APIBaseTestCase):
    def setUp(self):
        ...
        self.tutor = Tutor.objects.get(pk=1)
    ...
    def test_request_get_list_one_tutor(self):
        ...
        response = self.client.get(f"{self.url}{self.tutor.pk}/")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_request_delete_tutor(self):
        ...
        response = self.client.delete(f"{self.url}{self.tutor.pk}/")
    ...
    def test_request_put_tutor(self):
        ...
        response = self.client.put(f"{self.url}{self.tutor.pk}/", datas)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
