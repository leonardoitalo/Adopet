...
class UserLoginTest(APITestCase):
    def setUp(self):
        ...
        self.user = Tutor.objects.create_user(email='user@example.com', name='Test User', password='ValidPassword123')
        self.url = reverse('token_obtain_pair')  # Defina o nome da URL para obter o token de autenticação
