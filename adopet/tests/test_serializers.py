...
class SerializerTutorTestCase(TestCase):
    def setUp(self):
        self.tutor = Tutor(
            name="Teste de Modelo Tutor", email="tutor@teste.com", password="12345678"
        )
        ...
        self.adoption = Adoption(date="2024-10-9", pet=self.pet, tutor=self.tutor)
    ...
    def test_check_serializers_fields_tutor(self):
        ...
        self.assertEqual(set(datas.keys()), set(["id", "name", "email", "password"]))
    ...
    def test_check_serializers_fields_shelter(self):
        ...
        self.assertEqual(set(datas.keys()), set(["id", "name"]))
    ...
    def test_check_serializers_fields_adoption(self):
        ...
        self.assertEqual(set(datas.keys()), set(["id", "date", "pet", "tutor"]))
